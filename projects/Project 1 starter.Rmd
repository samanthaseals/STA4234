...
\[ \hat{Y} = \hat{\beta}_{\text{age}} X_{\text{age}} + \hat{\beta}_{\text{BMI}} X_{\text{BMI}} + \hat{\beta}_{\text{HbA1c}} X_{\text{HbA1c}} + \hat{\beta}_{\text{stress}} X_{\text{stress}} + \hat{\beta}_{\text{discrimination}} X_{\text{discrimination}} \]
...
#### 8. Based on your results in Q05, which, if any, are significant predictors of systolic blood pressure? You do not need to provide the formal hypothesis test for each predictor, however, you must justify your response.
